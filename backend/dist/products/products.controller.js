...
const auth_access_guard_1 = require("../auth/guards/auth-access.guard");
...
__decorate([
    (0, common_1.UseGuards)(auth_access_guard_1.AuthAccessGuard, admin_role_guard_1.AdminRoleGuard),
    (0, common_1.Post)(),
